/****************************************************************************
    ...
    $Id: global.h,v 1.2 2008/11/26 08:32:24 stefano Exp $

  -------------------------------------------------------------------------

                $Date: 2008/11/26 08:32:24 $

				Modified by Kalycito for windows porting.
...
#define DBUG_PRNT printf

//TODO: STF - this simbol has to be defined in the makefile
//#define __ARM966__
#define __CORTEXM3__
...
#define _DEV_GNU_ARM9_			(_DEV_BIT32_ | _DEV_GNUC_ARM7_ | _DEV_64BIT_SUPPORT_) // | _DEV_COMMA_EXT_)
#define _DEV_GNU_CORTEXM3_		(_DEV_BIT32_ | _DEV_GNU_ARM9_ | _DEV_64BIT_SUPPORT_) // | _DEV_COMMA_EXT_)
...
#warning "F590,F543,F598,F495 NOOS"
    #define TARGET_SYSTEM   _NO_OS_
...
#elif defined(__GNUC__) && defined(__arm__) && !defined(__ARM966__) && !defined(__CORTEXM3__)
#warning "ARM E GNUC NOOS"
    #define TARGET_SYSTEM   _NO_OS_
...
//---------------------------------------------------------------------------
//  definitions for ARM966 family with GNU compiler
//---------------------------------------------------------------------------

#elif defined(__GNUC__) && defined(__arm__) && defined(__ARM966__)
#warning "ARM966 FREERTOS"
    #define TARGET_SYSTEM   _FREERTOS_
    #define DEV_SYSTEM      _DEV_GNU_ARM9_
	...
	// TODO: STF - try to check 64 bit support on ARM9
	#ifndef QWORD
...
//---------------------------------------------------------------------------
//  definitions for Cortex M3 family with GNU compiler
//---------------------------------------------------------------------------

#elif defined(__CORTEXM3__)
#warning "CORTEXM3 FREERTOS"
    #define TARGET_SYSTEM   _FREERTOS_
    #define DEV_SYSTEM      _DEV_GNU_CORTEXM3_
...
#warning "BORLANDC PARADIGM NOOS"
...
//TODO: STF - segue la linea di codice originale.
//#ifdef NDEBUG
#ifndef NDEBUG
